...
public class FollowerConstants {
    ...
    private static double xMovement = 74.7155423965;
    private static double yMovement = 57.08471823295847;
    ...
    public static double mass = 8.80;
    ...
    public static double forwardZeroPowerAcceleration = -45.24;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -87.95;
