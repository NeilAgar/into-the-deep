...
public class FollowerConstants {
    ...
    private static double xMovement = 71.2461621789;
    private static double yMovement = 58.72;
    ...
    public static double drivePIDFFeedForward = 0.15;
    ...
    public static double mass = 12.80;
    ...
    public static double forwardZeroPowerAcceleration = -39.3155081858547;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -102.93942951583033;
